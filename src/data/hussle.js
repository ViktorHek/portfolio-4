  ...
  html: (
    <div className="content">
      ...
      <p>
        ...
        quite similar, and most of them are feeling okay. There is a political message behind my
        art. It's okay to just feel okay. When we ask each other how we feel, "just okay" is seen as
        a negative response that calls for a follow-up question. The background is a happy, colorful
      ...
      <br />
      <p>
        The pop-up windows are a representation of how my mind works. Cluttered, unorganized but
        packed with ideas, projects and information that interest me. Some windows might seem random
        and out of place. But this is (for better or worse) what occupies my mind every single day.
      </p>
      <p>
        And yes, I always have a ton of tabs open. The user's ability to minimize and move the
        windows around is to imitate my structuring process. it's possible, you just have to put in
