    ...
    <div className="content">
      ...
      <ul>
        <li>
          ...
          plan is to imitate the original with added modern features. This game is written in react
      ...
      <ul>
        ...
        <li>
          <strong>Functionality:&nbsp;</strong>Both doos have a counter. The AI selects the one with
          the lowest count. This is the reason for the name "No Cap".
        </li>
