  ...
  <div className="content">
    ...
    <ul>
      ...
      <li>
        ...
        new line, move placeholder by arrow/mouse, make text bold/icalic and change alignment.
      </li>
    ...
    <ul>
      <li>
        ...
        is to imitate the original with added moderne features. This game is written in react
      ...
      <li>
        ...
        When steping on grass or water, there is a chans of encountering a pokemon. You can defet it
    ...
    <ul>
      <li>
        You get two options: Door #1 & Door #2. The AI robot will guess witch door you pick. If the AI is wrong, you win.
      </li>
      <li>
      <strong>Functionality:&nbsp;</strong>Both doos have a counter. The AI selects the one with the lowes count. This is the reason for the name "No Cap".
      </li>
    </ul>
    <br />
  </div>
