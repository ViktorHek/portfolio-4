    ...
    <div class="main_drip_container">
      {drips.map((el) => {
        return (
          ...
          <path
            d="M296.081 87.9687C312.696 22.1049 367.616 1.87967 393 0H0.37939C58.1352 0 89.0569 58.6458 97.2983 87.9687C109.496 159.02 146.549 300.898 197.184 299.996C260.478 298.868 275.313 170.298 296.081 87.9687Z" />
        </svg>)
        })}
      </div>
